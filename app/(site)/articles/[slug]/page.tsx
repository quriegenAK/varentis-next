...
import { getArticle, getArticleSlugs } from '@/sanity/fetchers'
...
export default async function ArticlePage(
  ...
  return (
    <div style={{ background: 'var(--bg-0)', minHeight: '100vh', transition: 'background 0.4s ease' }}>
      ...
      {/* Breadcrumb */}
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '100px 48px 0' }}>
      ...
      <div style={{
        ...
        paddingTop: 40, paddingBottom: 72, transition: 'background 0.4s ease',
        marginTop: 24,
      }}>
